...
FactoryBot.create(:user, :with_workspaces, :with_projects, :with_comments_for_projects, :with_tasks, :with_comments_for_tasks)
FactoryBot.create(:user, :with_workspaces, :with_projects, :with_comments_for_projects, :with_tasks, :with_comments_for_tasks, :with_watchers)